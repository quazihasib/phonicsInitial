...
public class Letter5 extends Sprite
{

	public static int letter5Count;
	
	public Letter5(float pX, float pY, ITextureRegion pTextureRegion,VertexBufferObjectManager vertexBufferObjectManager) 
	{
