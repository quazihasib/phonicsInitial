...
public class Letter7 extends Sprite
{

	public static int letter7Count;
	
	public Letter7(float pX, float pY, ITextureRegion pTextureRegion,VertexBufferObjectManager vertexBufferObjectManager) 
	{
