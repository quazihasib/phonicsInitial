...
public class Letter6 extends Sprite
{

	public static int letter6Count;
	
	public Letter6(float pX, float pY, ITextureRegion pTextureRegion,VertexBufferObjectManager vertexBufferObjectManager) 
	{
